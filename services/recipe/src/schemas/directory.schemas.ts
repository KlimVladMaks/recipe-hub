...
export const PaginatedDishTypesSchema = z.object({
    items: DishTypeReadListSchema,
    total: z.number(),
    page: z.number(),
    limit: z.number(),
});
export type PaginatedDishTypesType = z.infer<typeof PaginatedDishTypesSchema>;
...
export const PaginatedIngredientsSchema = z.object({
    items: IngredientReadListSchema,
    total: z.number(),
    page: z.number(),
    limit: z.number(),
});
export type PaginatedIngredientsType = z.infer<typeof PaginatedIngredientsSchema>;
